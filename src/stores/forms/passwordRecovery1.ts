  ...
  constructor(formsStore?: FormsStore) {
    ...
    this.onSubmit = async (event?: SyntheticEvent) => {
      ...
      if (this.isValid) {
        ...
        const result = await userStore?.passwordRecovery(values.login as string)
